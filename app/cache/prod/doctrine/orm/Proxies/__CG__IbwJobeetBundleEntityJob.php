...
class Job extends \Ibw\JobeetBundle\Entity\Job implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'id', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'type', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'company', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'logo', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'url', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'position', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'location', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'description', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'how_to_apply', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'token', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'is_public', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'is_activated', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'email', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'expires_at', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'created_at', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'updated_at', '' . "\0" . 'Ibw\\JobeetBundle\\Entity\\Job' . "\0" . 'category', 'file');
        }
